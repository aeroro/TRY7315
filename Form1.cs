    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            /*
                    ...
                    decimal mony = perc * dayCount / 365 ;
                    mony = Math.Truncate(mony);


                    this.label5.Text = $"使用期間: {dateTimePicker1.Value.Year}-{dateTimePicker1.Value.Month}-{dateTimePicker1.Value.Day} ~ {dateTimePicker2.Value.Year}-{dateTimePicker2.Value.Month}-{dateTimePicker2.Value.Day} "+ "\r\n"  +
                    $"計算天數: {dayCount}" + "\r\n" +
                    $"汽缸CC數: {comboBox2.Text}" + "\r\n" + 
                    $"用途: {comboBox1.Text}" +"\r\n" +
                    $"計算公式: {perc} * {dayCount} / 365 = {mony}元" + "\r\n" +
                    $"應納稅額: 共 {mony} 元" ;
                   */
